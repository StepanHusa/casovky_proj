...
-   Po diferenciaci: ACF má výrazný lag 1,2 PACF také (o něco méně/možná postupný útlum) → vhodné modely `ARIMA(1,1,2)` nebo blízké alternativy. Také pozorujeme lineární pokles na sezoních lazích u acf, bude nutná i sezoní diferenciace
